...
class videocall extends AppCompatActivity implements Session.SessionListener, PublisherKit.PublisherListener {
    ...
    private void requestPermissions()
    {
        ...
        {
            String SESSION_ID = "2_MX40Njc2MTA3Mn5-MTU5MDQwOTgxOTM3M34xY1hxOVBrT1pyUTlmR2FJSENGd2VZd05-fg";
            String API_KEY = "46761072";
            session=new Session.Builder(this, API_KEY, SESSION_ID).build();
            session.setSessionListener(this);
            String TOKEN = "T1==";
