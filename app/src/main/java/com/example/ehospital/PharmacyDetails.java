...
public class PharmacyDetails
{
    ...
    public PharmacyDetails(String pharmname,String mail, String location, String proprietorname, String licnumber,String doctororlab,String profile_pic,String address,String phonenumber,String uidpharmreg,float ratings,double lats,double longs) {
